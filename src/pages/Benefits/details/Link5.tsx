    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Through scripting and automation features, teams can speed up repetitive layout processes such as creating specification tables or generating multiple product pages. This allows designers to focus more on creativity and strategy rather than manual production tasks.
          </p>
        </div>
      </div>
