    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Because the platform follows professional publishing standards, students and new designers learn workflows that match industry expectations. This prepares them to communicate design ideas using professional documentation formats.
          </p>
