    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Running across multiple platforms, REACH Framio allows design, development, merchandising, and marketing teams to work from the same visual environment. This improves communication and helps teams make faster, more confident decisions.
          </p>
